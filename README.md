...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        body {
            background-color: #fcfbf9; /* 非常に淡いベージュ */
            color: #4a4a4a;
        ...
        .hero-image { flex-grow: 1; background: #e5e3de; } /* ここに写真を入れる */
...
<body>
    ...
    <section class="hero">
        <h1>Whitespace</h1>
        <div class="hero-image"></div> <!-- imgタグで置換してください -->
    </section>

    <!-- ② 写真日記セクション -->
    <section class="section">
        <div class="diary-item">
            <img src="https://via.placeholder.com/800x500" alt="Diary photo">
